...
**Status:** Week 1 — foundations. Public URL targeted for Week 11.
...
**Status at Week 1:** all 7 adapters are stubs that raise `NotImplementedError`. Week 2 implements UK end-to-end as the template.
